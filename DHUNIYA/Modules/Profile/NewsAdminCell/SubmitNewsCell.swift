...
class SubmitNewsCell: UITableViewCell {
    ...
    @IBOutlet weak var sportsTagBtn: UIButton!
    @IBOutlet weak var addTagsLbl: UILabel!
    @IBOutlet weak var removeSportsTagBtn: UIButton!
    @IBOutlet weak var carsandbikesBtn: UIButton!
    @IBOutlet weak var addtagsTf: UITextField!
    @IBOutlet weak var removePoliticsTagBtn: UIButton!
